...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        permission2 = Permission.objects.get(name='Can see all borrowed books')
    ...
    # Más correctamente llamado en el archivo de github del tutorial:
    # test_forbidden_if_logged_in_but_not_correct_permission(self):
    def test_redirect_if_logged_in_but_not_correct_permission(self):
        login = self.client.login(username='testuser1', password='12345')
        resp = self.client.get(reverse('renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk,}) )
        # Añadida esta línea después de ver el archivo de github del tutorial, cambiando responde por resp.
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        # Sin reverse sería: response = self.client.get('/catalog/author/create/')
